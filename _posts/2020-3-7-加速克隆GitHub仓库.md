...
[程序羊视频链接](https://www.bilibili.com/video/av94251133)
...
```
也可以修改`.git`文件夹下的`config`文件。
![](https://raw.githubusercontent.com/liyanan24/images/master/20200307205313.png)
...
将Github上的仓库导入到码云仓库中即可 ，然后从码云仓库中克隆，然后重新链接到Github的仓库上即可。